            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        id: 'P3',
                        title: 'Email',
                        body: 'Адрес электронной почты (если вы его указали) и факт подтверждения. Служебные коды (подтверждение email, сброс пароля) отправляются на этот адрес через российский SMTP.'
                    },
                    {
                        id: 'P4',
                ...
                items: [
                    {
                        id: 'P6',
                        title: 'Цели',
                        body: 'Работа сервиса (карта, кабинет, сообщения, модерация), подтверждение email, восстановление доступа по email, безопасность и исполнение законодательства РФ.'
                    },
                    {
                        id: 'P7',
                        title: 'Основания',
            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        id: 'P9',
                        title: 'Третьи лица',
                        body: 'Яндекс (карты, при необходимости облако/перевод); служебные письма (код подтверждения email и сброса пароля) — через российский SMTP (Reg.ru / аналог в РФ), без зарубежных ESP для ПДн. Персональные данные не продаются.'
                    },
                    {
                        id: 'P10',
                        title: 'Срок',
                ...
                items: [
                    {
                        id: 'T2',
                        title: 'Регистрация',
                        body: 'Для регистрации нужны логин, пароль, email и согласие на обработку персональных данных. Вы отвечаете за сохранность доступа. Восстановление пароля — по подтверждённому email (код в письме с noreply@polevka.art).'
                    },
                    {
                        id: 'T3',
                        title: 'Запреты',
