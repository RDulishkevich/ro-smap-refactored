...
export const translations = {
    ...
    en: {
        ...
        add_audio_title: "Add Audio", drag_drop: "Click or drag audio file here (.wav)", display_title: "Display Title (Internal)", sound_desc: "Sound Description", file_name: "File Name (UCS)", file_name_ucs: "Generated File Name (UCS)", keywords: "Free tags (comma separated)", add_photo: "Attach photos (up to 3)", user_defined: "FXName (EN)", translate_fxname: "Translate from description", fxname_hint: "Short English UCS title (no underscores). Auto from description or edit manually.",
