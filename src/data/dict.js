...
export const translations = {
    ...
    en: {
        ...
        add_audio_title: "Add Audio", drag_drop: "Click or drag audio file here (.wav)", display_title: "Display Title (Internal)", sound_desc: "Sound Description", file_name: "File Name (UCS)", file_name_ucs: "Generated File Name (UCS)", keywords: "Free tags (comma separated)", add_photo: "Attach photos (up to 3)", user_defined: "FXName (EN)", translate_fxname: "Refresh translation", fxname_hint: "English UCS name: words joined with _. Auto-translated from the description.",
