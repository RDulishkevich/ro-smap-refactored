...
export const translations = {
    ru: {
        ...
        settings_title: "Настройки", gui_scale: "Масштаб интерфейса", theme: "Тема оформления", color_palette: "Цветовая палитра", palette_coral: "Коралл", palette_terre: "Терракота", palette_sparrow: "Хвоя", map_provider: "Движок карты", map_provider_yandex: "Яндекс", map_provider_mapbox: "Mapbox 3D", mapbox_token: "Mapbox Access Token", mapbox_token_save: "Сохранить токен", mapbox_token_get: "Получить", mapbox_token_hint: "Нужен публичный токен Mapbox (pk.…). Стиль Standard с 3D-зданиями, рельефом и наклоном камеры.", map_style: "Стиль карты (Фильтр)", map_normal: "Стандарт", map_mono: "Монохром", language: "Язык", close: "Закрыть",
    ...
    en: {
        ...
        settings_title: "Settings", gui_scale: "Interface Scale", theme: "Visual Theme", color_palette: "Color palette", palette_coral: "Coral", palette_terre: "Terracotta", palette_sparrow: "Sparrow", map_provider: "Map engine", map_provider_yandex: "Yandex", map_provider_mapbox: "Mapbox 3D", mapbox_token: "Mapbox Access Token", mapbox_token_save: "Save token", mapbox_token_get: "Get token", mapbox_token_hint: "A public Mapbox token (pk.…) is required. Standard style with 3D buildings, terrain, and camera pitch.", map_style: "Map Style (Filter)", map_normal: "Default", map_mono: "Monochrome", language: "Language", close: "Close",
