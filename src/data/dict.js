...
export const translations = {
    ru: {
        ...
        settings_title: "Настройки", gui_scale: "Масштаб интерфейса", theme: "Тема оформления", color_palette: "Цветовая палитра", palette_coral: "Коралл", palette_terre: "Терракота", palette_sparrow: "Хвоя", map_style: "Стиль карты (Фильтр)", map_normal: "Стандарт", map_mono: "Монохром", language: "Язык", close: "Закрыть",
    ...
    en: {
        ...
        settings_title: "Settings", gui_scale: "Interface Scale", theme: "Visual Theme", color_palette: "Color palette", palette_coral: "Coral", palette_terre: "Terracotta", palette_sparrow: "Sparrow", map_style: "Map Style (Filter)", map_normal: "Default", map_mono: "Monochrome", language: "Language", close: "Close",
