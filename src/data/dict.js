...
export const translations = {
    ru: {
        ...
        settings_title: "Настройки", gui_scale: "Масштаб интерфейса", theme: "Тема оформления", color_palette: "Цветовая палитра", palette_coral: "Коралл", palette_terre: "Терракота", palette_sparrow: "Хвоя", map_provider: "Движок карты", map_provider_yandex: "Яндекс", map_provider_ozon: "Ozon Maps", map_provider_mapbox: "OSM 3D", map_provider_carto: "Carto", map_provider_opentopo: "OpenTopo", map_provider_esri: "Esri Sat", map_provider_dgis: "2GIS 3D", map_provider_google: "Google Earth", map_provider_yandex_hint: "Классическая карта Яндекса — быстрый и стабильный режим по умолчанию.", map_provider_ozon_hint: "Ozon Maps — бесплатные тайлы OpenStreetMap (Carto Voyager). Отдельного API маркетплейса Ozon нет.", map_provider_osm_hint: "OpenStreetMap 3D (MapLibre + OpenFreeMap): наклон камеры и объёмные здания, без ключа.", map_provider_carto_hint: "Carto basemaps — бесплатный CDN на данных OSM, без ключа.", map_provider_opentopo_hint: "OpenTopoMap — бесплатная топографическая карта (OSM + рельеф).", map_provider_esri_hint: "Esri World Imagery — бесплатные спутниковые тайлы (с атрибуцией Esri).", map_provider_dgis_hint: "2GIS MapGL: immersive 3D, здания и глобус. Нужен ключ platform.2gis.ru.", map_provider_google_hint: "Photorealistic 3D Google (Earth-подобный вид). Нужен ключ Maps JavaScript API.", map_style: "Стиль карты (Фильтр)", map_normal: "Стандарт", map_mono: "Монохром", language: "Язык", close: "Закрыть",
