import { initGlobalState } from './state.js?v=20260721p';
import './api.js?v=20260721p';
import { initAuth } from './auth.js?v=20260721p';

import './sfx.js?v=20260721p';
import './antispam.js?v=20260721p';
import '../ui/ui.js?v=20260721p';
import './audio.js?v=20260721p';
import './map.js?v=20260721p';
import './mapbox-map.js?v=20260721p';
import './dgis-map.js?v=20260721p';
import './google-earth-map.js?v=20260721p';
import './yandex3-map.js?v=20260721p';
import './achievements.js?v=20260721p';
import './guessr.js?v=20260721p';
import './admin-console.js?v=20260721p';
import './support-bot.js?v=20260721p';
import './pwa.js?v=20260721p';
import './events.js?v=20260721p';
import './ucsName.js?v=20260721p';
import './wavMeta.js?v=20260721p';
import './wavReadMeta.js?v=20260721p';
import './audioConvert.js?v=20260721p';
import '../data/publishRules.js?v=20260721p';
import '../data/legalDocs.js?v=20260721p';
import '../data/gearCatalog.js?v=20260721p';
import '../widgets/analytics-widget.js?v=20260721p';
