...
window.SUPPORT_BOT_FAQ = [
    ...
    },
    {
        ...
        answer: 'Здравствуйте! Я бот поддержки RO·SMap. Опишите вопрос своими словами — подскажу по FAQ. Если ответа не хватит, напишите «обращение».'
    }
];
...
window.appendSupportBotReply = async function(userLogin, text, extra = {}) {
    ...
    const msg = {
        ...
        fromName: window.SUPPORT_NAME || 'Поддержка RO·SMap',
        text,
